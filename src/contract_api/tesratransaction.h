#ifndef TESRA_TRANSACTION_H
#define TESRA_TRANSACTION_H
...
class TesraTransaction : public dev::eth::Transaction
{

public:

    TesraTransaction() : nVout(0)
    {
    }

    TesraTransaction(dev::u256 const &_value, dev::u256 const &_gasPrice, dev::u256 const &_gas, dev::bytes const &_data,
                    dev::u256 const &_nonce = dev::Invalid256) :
            dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce)
    {
    }

    TesraTransaction(dev::u256 const &_value, dev::u256 const &_gasPrice, dev::u256 const &_gas,
