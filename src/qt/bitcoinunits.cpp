...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TSR);
    unitlist.append(mTSR);
    unitlist.append(uTSR);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TSR:
            return QString("tTSR");
        case mTSR:
            return QString("mtTSR");
        case uTSR:
            return QString::fromUtf8("μtTSR");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TSR:
            return QString("TSR");
        case mTSR:
            return QString("Milli-TSR (1 / 1" THIN_SP_UTF8 "000)");
        case uTSR:
            return QString("Micro-TSR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TSR:
            return QString("TestTSRs");
        case mTSR:
            return QString("Milli-TestTSR (1 / 1" THIN_SP_UTF8 "000)");
        case uTSR:
            return QString("Micro-TestTSR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
