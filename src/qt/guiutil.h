...
/** Utility functions used by the TESRA Qt UI.
 */
namespace GUIUtil
{
...
// Render TESRA addresses in monospace font
...
// Parse "tesra:" URI into recipient object, return true on successful parsing
