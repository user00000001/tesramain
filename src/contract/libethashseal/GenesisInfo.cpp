...
#include "genesis/tesraMainNetwork.cpp"
...
#include "genesis/test/tesraTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::tesraMainNetwork: return c_genesisInfoTesraMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::tesraTestNetwork: return c_genesisInfoTesraTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::tesraMainNetwork: return c_genesisStateRootTesraMainNetwork;
    case Network::tesraTestNetwork: return c_genesisStateRootTesraTestNetwork;
