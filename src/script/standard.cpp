...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet,bool contractConsensus)
{
    ...
    BOOST_FOREACH(const PAIRTYPE(txnouttype, CScript)& tplate, mTemplates)
    {
        ...
        VersionVM version;      //  tesra-vm
        version.rootVM = 20;    //  tesra-vm set to some invalid value
...
bool ExtractDestination(const CScript& scriptPubKey, CTxDestination& addressRet, txnouttype *typeRet)    ////////////tesra-vm,added  typeRet as a param
