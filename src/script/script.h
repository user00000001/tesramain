...
static const unsigned int MAX_SCRIPT_ELEMENT_SIZE = 128000; //(128 kb) // tesra-vm

//static const int MAX_SCRIPT_SIZE = 10000;
static const int MAX_SCRIPT_SIZE = 129000; // (129 kb) // tesra-vm
...
enum opcodetype
{
    ...
    // Execute EXT byte code.  //tesra-vm
    OP_CREATE = 0xc3,
    OP_CALL = 0xc4,
    OP_SPEND = 0xc5,
    OP_VM_STATE = 0xc6,  //tesra-vm

    OP_EXT_DATA = 0xc7,

    // template matching params
    OP_HASH_STATE_ROOT = 0xf3,    //tesra-vm
    OP_HASH_UTXO_ROOT = 0xf4,    //tesra-vm
    OP_GAS_PRICE = 0xf5,    //tesra-vm
    OP_VERSION = 0xf6,
    OP_GAS_LIMIT = 0xf7,
    OP_DATA = 0xf8,         //tesra-vm
