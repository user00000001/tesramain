...
DEFINES += ENABLE_WALLET  TESRA_BUILD POW_IN_POS_PHASE HAVE_BUILD_INFO ETH_FATDB=1 HAVE_CONFIG_H
...
SRCPATH=$$PWD/../../../tesrasupernet/src   
INCLUDEPATH += $$SRCPATH/
INCLUDEPATH += $$SRCPATH/leveldb/include
INCLUDEPATH += $$SRCPATH/univalue/include

INCLUDEPATH += $$SRCPATH/contract_api
INCLUDEPATH += $$SRCPATH/contract
INCLUDEPATH += $$SRCPATH/contract/utils

unix:!macx{
DEPENDSINCLUDEPATH=$$PWD/../../../depends/x86_64-pc-linux-gnu/include
}
macx{
DEPENDSINCLUDEPATH=$$PWD/../../../depends/x86_64-apple-darwin11/include
}

INCLUDEPATH += $$DEPENDSINCLUDEPATH/
...
TRANSLATIONS +=  locale/tesra_en.ts \
                 locale/tesra_zh_CN.ts
#                locale/tesra_bg.ts \
#                locale/tesra_de.ts \
#                locale/tesra_es.ts \
#                locale/tesra_fi.ts \
