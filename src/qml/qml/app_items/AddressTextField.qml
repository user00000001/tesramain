...
//    }
       ...
       // height:hintlistview.contentHeight>200?220:hintlistview.contentHeight+20
        contentItem: ListView {
            ...
            delegate:MenuItem {
                ...
                {
                    color:hintlistview.currentIndex == index?"#8B0068B7":(hovered?"#D3D3D3":"#FFFFFF")
                }
    ...
    style: Controls_Style_1.TextFieldStyle{
        background: Rectangle{
            color: (backgroundColor == undefined)?(root.focus?"#3285C4":"#BB3285C4"):(root.focus?backgroundFocusColor:backgroundColor)

            border.color: critical?"#00A0E9":(root.focus?"#4B4674":(root.hovered?"#7B3285C4":"#3285C4"))
