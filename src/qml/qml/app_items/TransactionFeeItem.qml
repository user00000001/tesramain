...
Item {
    ...
    {
        if(root_window.unitName === "  TSR"){
            amountField.coinTypeBtn.text = "TSR"
            amountField.coinTypeBtn.index = 0
        }
        else if(root_window.unitName === "  mTSR"){
            amountField.coinTypeBtn.text = "mTSR"
            amountField.coinTypeBtn.index = 1
        }
        else{
            amountField.coinTypeBtn.index = 2
            amountField.coinTypeBtn.text = "μTSR"
        }
    ...
    CommonCheckBox {
        ...
        height:20
        checked: false
        text: qsTr("Pay only the minimum fee of 0.00010000 TSR/kB  (read the tooltip)")
        visible:!minimized
        enabled:custom_btn.checked
