...
Controls_1_4.TableView {
    ...
    rowDelegate: Rectangle{
        ...
        color: styleData.selected? "#F2F5F8":(styleData.alternate ? "#FAFAFA" :"#FAFAFA")
        height:32
        //radius: 3
    ...
    itemDelegate:Text{
        ...
        color: styleData.selected? "#3D4966" : "#3D4966"
    ...
    style:Controls_Style_1_4.TableViewStyle{
       ...
       // transientScrollBars:true
        ...
        handle:Rectangle {
            implicitWidth:8
            implicitHeight:10
            color: styleData.pressed?"#4D4975":styleData.hovered?"#9B3285C4":"#3B3285C4"
            radius: 2
        }
