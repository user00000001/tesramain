...
Controls_1.TextArea
{
    ...
    style: Controls_Style_1.TextAreaStyle {
        ...
        backgroundColor:readOnly?"#F0F0F0":(root.backgroundColor === "" ? (root.focus?"#F0F0F0":"#FAFAFA"): root.backgroundColor)


        frame: Rectangle
        {
            radius:2
            color:critical?"#00A0E9":(root.focus?"#4B4674":(root.hovered?"#7BD5D9E8":"#D5D9E8"))
