...
//    }
    ...
    style: Controls_Style_1.TextFieldStyle{
        background: Rectangle{
            color: (backgroundColor == undefined)?(root.focus?"#F1F2F6":"#FAFAFA"):(root.focus?backgroundFocusColor:backgroundColor)

            border.color: critical?"#00A0E9":(root.focus?"#3285C4":(root.hovered?"#D5D9E8":"#D5D9E8"))
