...
Rectangle{
    ...
    color:walletModel.isTestNet()?"#3F6D2A":"#0068B7"
    ...
    CommonMenuButton
    {
        ...
        model: ListModel
        {
            ...
            ListElement { modelData: qsTr("About Tesra Core"); }
    ...
    CommonMenuButton
    {
        ...
        CommonDialog
        {
            ...
            content_text: qsTr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (tesra.conf).")
            width:480
            height: 200
...
//            case 3:signInfoDialog.current_index=1;signInfoDialog.show();signInfoDialog.raise();break;
            case 2:sendAddressDialog.show();sendAddressDialog.raise();break;
            case 3:receiveAddressDialog.show();receiveAddressDialog.raise();break;
...
//            case 8:multiSignAddressInterDialog.show();multiSignAddressInterDialog.current_index=2;multiSignAddressInterDialog.raise();break;
            case 4:rpcConsole.changeNetWork();break;
