...
Controls_1_4.Tab {
    ...
    Rectangle {
        ...
        CommonTableView
        {
            ...
            titles: ["Status","Date","Type","Address","Amount(TSR)"]
            ...
            Component {
                ...
                Text{
                    ...
                    color: styleData.value.split("|")[1] === "6"?"#BB3D4966": (styleData.selected? "#3D4966" : "#3D4966")
            ...
            Component {
                ...
                Item {
                    ...
                    Text{
                        ...
                        color: styleData.value.split("|")[2] === "6"?"#BB3D4966": (styleData.selected? "#3D4966" : "#3D4966")
                        elide:styleData.elideMode
        ...
        {
            id:export_btn
            color: walletModel.isTestNet()?"#202020":"#0068B7"
            anchors.right: parent.right
            anchors.rightMargin: 30
            anchors.bottom: parent.bottom
            width: 83
