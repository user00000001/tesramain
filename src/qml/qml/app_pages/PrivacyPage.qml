...
Controls_1_4.Tab {
    ...
    Rectangle {
        ...
        Label
        {
            ...
            anchors.verticalCenter: mint_zero_btn.verticalCenter
            color: "#3D4966"
            text:qsTr("zTSR Available for Minting: 0.00 TSR")
        }
        ...
        Label
        {
            ...
            color: "#3D4966"
            text:qsTr("Availabel Balance: <b>")+ "0&nbsp;&nbsp;zTSR</b> "
        }
