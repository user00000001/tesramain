...
ApplicationWindow {
    ...
    Rectangle{
        ...
        Rectangle
        {
            ...
            width: 180
            color:walletModel.isTestNet()?"#FAFAFA":"#FAFAFA"
        }
...
//        }
    ...
    CommonDialog
    {
        ...
        content_text: qsTr("Tesra Core is shutting down...") + "<br /><br />" +
    ...
    {
        id:exit_dialog
        title: qsTr("Quit Tesra")
        confirm_btn_text: qsTr("Ok")
        cancel_btn_text: qsTr("Cancel")
        content_text: qsTr("Confirm quitting Tesra Core")
        modality: Qt.ApplicationModal
