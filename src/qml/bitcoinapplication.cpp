...
void BitcoinApplication::createTrayIcon()
{
    ...
    QString toolTip = tr("TESRA Core client");
...
//            connect(walletModel, SIGNAL(requireUnlock()), this, SLOT(unlockWallet()));
        ...
        // TESRA: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", ("A fatal error occurred. TESRA can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
...
{
    QString strTitle = tr("TESRA Core"); // default title
...
void BitcoinApplication::startToolsAndMessageCore()
{
   ...
   // receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive"), this);
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTSR"));
