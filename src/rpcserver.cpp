...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tesra features */
        {"tesra", "masternode", &masternode, true, true, false},
        {"tesra", "listmasternodes", &listmasternodes, true, true, false},
        {"tesra", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tesra", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tesra", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tesra", "masternodedebug", &masternodedebug, true, true, false},
        {"tesra", "startmasternode", &startmasternode, true, true, false},
        {"tesra", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tesra", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tesra", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tesra", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tesra", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tesra", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tesra", "mnbudget", &mnbudget, true, true, false},
        {"tesra", "preparebudget", &preparebudget, true, true, false},
        {"tesra", "submitbudget", &submitbudget, true, true, false},
        {"tesra", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tesra", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tesra", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tesra", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tesra", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tesra", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tesra", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tesra", "checkbudgets", &checkbudgets, true, true, false},
        {"tesra", "mnsync", &mnsync, true, true, false},
        {"tesra", "spork", &spork, true, true, false},
        {"tesra", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"tesra", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> tesra-cli " + methodname + " " + args + "\n";
}
