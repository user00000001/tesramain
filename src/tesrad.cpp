 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called TESRA (http://www.tesra.org),
...
int main(int argc, char* argv[])
{
    ...
    // Connect tesrad signal handlers
    noui_connect();
