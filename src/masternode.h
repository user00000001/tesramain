...
#define MASTERNODE_COIN_AMOUNT 10000
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 TSR, signature to prove
